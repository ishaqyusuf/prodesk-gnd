...
export function FormFooter({ sticky }: { sticky: Sticky }) {
    ...
    return (
        <div
            ...
            className={cn(
                ...
                isFixed &&
                    "fixed border-2 border-muted-foreground/50 shadow-xl  overflow-hidden rounded-full  top-[60px] bg-background z-10"
            )}
        >
            <div className="">
                {tabs.map((tab) => (
            ...
            <Button
                ...
                variant="secondary"
            >
                <Icons.settings className="w-4 h-4 mr-4" />
