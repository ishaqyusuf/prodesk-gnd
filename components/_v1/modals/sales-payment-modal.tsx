    ...
    return (
        <BaseModal<ICustomer>
            ...
            onOpen={(customer) => {
                ...
                form.reset({
                    paymentOption:
                        customer.salesOrders[0]?.meta?.payment_option,
                });
                const _checked: any = {};
            ...
            Title={({ data: customer }) => (
                <div>
                    Apply Payment - {customer?.businessName || customer?.name}
                </div>
            )}
                ...
                <div className="grid gap-2">
                    ...
                    <div className="sm:flex max-sm:grid max-sm:grid-cols-2 max-sm:gap-4 sm:space-x-4 justify-end">
                        ...
                        <div className="grid gap-2">
                            ...
                            <Input
                                disabled={
                                    form.getValues("paymentOption") != "Check"
                                }
            ...
            Footer={({ data }) => (
                <Btn
                    disabled={
                        form.getValues("pay") == 0 && data?.wallet?.balance == 0
                    }
                    isLoading={isSaving}
