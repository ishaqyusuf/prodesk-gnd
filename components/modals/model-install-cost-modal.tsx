...
import { ICostChart, IHomeTemplate, InstallCost } from "@/types/community";
...
export default function ModelInstallCostModal() {
              ...
              <Table className="">
                ...
                <TableBody>
                  {costList?.meta?.list?.map((l, i) => (
                    <TableRow
                      className={cn(
                        form.getValues(`costs.${index}.costings.${l.uid}`) > 0
                          ? "bg-teal-50"
                          : ""
                      )}
                      key={i}
                    >
                      <TableCell className="px-1">
                        <PrimaryCellContent>{l.title}</PrimaryCellContent>
                        <SecondaryCellContent>
                          <Money value={l.cost} />
                          {" per qty"}
                        </SecondaryCellContent>
                      ...
                      <TableCell>
                        <Input
                          className="h-7 w-16"
                          type={"number"}
                          {...form.register(`costs.${index}.costings.${l.uid}`)}
                        />
                      </TableCell>
                    </TableRow>
                  ))}
