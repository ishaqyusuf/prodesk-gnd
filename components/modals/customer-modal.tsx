          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            {watchProfileId != -1 ? (
              <div className="grid gap-2 col-span-2">
                ...
                <Select
                  onValueChange={(value) => {
                    form.setValue("customerTypeId", Number(value));
                  }}
                  value={`${form.getValues("customerTypeId")}`}
                >
              ...
              <>
                <div className="grid gap-2 grid-cols-6 items-end">
                  <div className="">
                    <Button
                      onClick={() => form.setValue("customerTypeId", null)}
                  ...
                  <div className="grid gap-2 col-span-5">
                    ...
                    <Input
                      placeholder=""
                      className="h-8"
                      {...form.register("profile.coefficient")}
                    />
                  </div>
                </div>
                <div className="grid gap-2">
            ...
            <div className="grid gap-2 ">
              ...
              <Input
                placeholder=""
                className="h-8"
                {...form.register("primaryAddress.meta.zip_code")}
              />
            </div>
          </div>
        </div>
